...
var Vue = require('vue');
var dom = require('./dep-eb214be8.js');
var renderTnode = require('./dep-c8d40779.js');
var camelCase = require('./dep-388cb46f.js');
var kebabCase = require('./dep-09b19404.js');
var isFunction = require('./dep-37af9215.js');
var isString = require('./dep-11e6da14.js');
var isObject = require('./dep-c644d54f.js');
...
function getTextFromVNode(VNodes) {
  if (!VNodes) return "";
  if (isString.isString(VNodes)) return VNodes;
  if (Array.isArray(VNodes)) {
    return filterCommentNode(VNodes).map(function (node) {
      return getTextFromVNode(node);
    }).filter(Boolean).join(" ");
  }
  if (dom.isCommentVNode(VNodes)) return "";
  if (isString.isString(VNodes.children)) {
  ...
  if (VNodes.children && isObject.isObject(VNodes.children)) {
    return Object.values(VNodes.children).map(function (child) {
      if (!child || isFunction.isFunction(child)) return "";
...
exports.getTextFromVNode = getTextFromVNode;
exports.useContent = useContent;
exports.useTNodeDefault = useTNodeDefault;
exports.useTNodeJSX = useTNodeJSX;
//# sourceMappingURL=dep-0e56b1da.js.map
