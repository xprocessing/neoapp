...
var index = require('../../../_chunks/dep-b56e7ff5.js');
...
var format = require('../../../_chunks/dep-d28d8b91.js');
...
require('../../../_chunks/dep-548039eb.js');
...
var TSinglePanel = Vue.defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      ...
      }, [["top", "left"].includes(props.presetsPlacement) ? Vue.createVNode(datePicker_components_panel_ExtraContent["default"], extraProps.value, slots.presets ? {
        presets: slots.presets
      } : {}) : null, Vue.createVNode(datePicker_components_panel_PanelContent["default"], panelContentProps.value, slots), ["bottom", "right"].includes(props.presetsPlacement) ? Vue.createVNode(datePicker_components_panel_ExtraContent["default"], extraProps.value, slots.presets ? {
        presets: slots.presets
      } : {}) : null]);
    };
  }
