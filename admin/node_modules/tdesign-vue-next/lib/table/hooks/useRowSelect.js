...
import { i as isRowSelectedDisabled } from '../../_chunks/dep-9fc2714d.js';
import { getLocalPaginationPageData } from '../utils/index.js';
...
function useRowSelect(props, tableSelectedClasses) {
  ...
  var currentPaginateData = ref(getLocalPaginationPageData(data.value, pagination.value, disableDataPage.value));
