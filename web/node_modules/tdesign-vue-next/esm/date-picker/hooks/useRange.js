...
import { g as getDefaultFormat, f as formatDate, b as isValidDate, p as parseToDayjs } from '../../_chunks/dep-f54e73f7.js';
...
function useRange(props) {
  ...
  var _useRangeValue = useRangeValue(props),
    ...
    _onChange = _useRangeValue.onChange,
    ...
    return _objectSpread(_objectSpread({}, props.rangeInputProps), {}, {
      ...
      onEnter: function onEnter(newVal) {
        ...
        if (isValidDate(newVal, formatRef.value.format)) {
          _onChange === null || _onChange === void 0 || _onChange(formatDate(newVal, {
            format: formatRef.value.format,
