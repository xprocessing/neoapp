...
var automaticNumbering = vue.defineComponent({
  ...
  setup(props, _ref) {
    ...
    var finalCls = vue.computed(() => ["t-icon", "t-icon-automatic-numbering", className.value]);
...
exports.default = automaticNumbering;
