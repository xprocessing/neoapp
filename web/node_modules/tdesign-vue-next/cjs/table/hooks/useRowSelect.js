...
var index = require('../../_chunks/dep-86694091.js');
var log = require('../../_chunks/dep-f7deb88a.js');
require('../../_chunks/dep-d1a4892a.js');
var utils = require('../../_chunks/dep-f0cbacdb.js');
...
var intersection = require('../../_chunks/dep-2bfa66aa.js');
var get = require('../../_chunks/dep-1e2d078f.js');
var isFunction = require('../../_chunks/dep-37af9215.js');
...
function useRowSelect(props, tableSelectedClasses) {
  ...
  var currentPaginateData = Vue.ref(table_utils_index.getLocalPaginationPageData(data.value, pagination.value, disableDataPage.value));
  ...
  var updateCurrentPaginateData = function updateCurrentPaginateData() {
    currentPaginateData.value = table_utils_index.getLocalPaginationPageData(data.value, pagination.value, disableDataPage.value);
  };
  Vue.watch([data, function () {
    var _pagination$value;
    return (_pagination$value = pagination.value) === null || _pagination$value === void 0 ? void 0 : _pagination$value.current;
  }, function () {
    var _pagination$value2;
    return (_pagination$value2 = pagination.value) === null || _pagination$value2 === void 0 ? void 0 : _pagination$value2.pageSize;
  }, disableDataPage], function () {
