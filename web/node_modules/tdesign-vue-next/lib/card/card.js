  ...
  setup: function setup(props2, _ref) {
    ...
    var renderContent = function renderContent() {
      ...
      return createVNode("div", {
        "class": baseCls.value
      }, [isHeaderRender.value ? renderHeader() : null, showCover.value ? renderCover() : null, (showContent.value || isLoading) && createVNode(Loading, mergeProps({
        "loading": isLoading
      }, props2.loadingProps), {
      ...
      }), isFooterRender.value && createVNode("div", {
    ...
    return function () {
      var loadingContent = renderTNodeJSX("loading");
      if (loadingContent) {
        return showLoading.value ? loadingContent : renderContent();
      }
      var isLoading = !!showLoading.value;
