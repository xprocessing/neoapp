...
import { u as useImagePreviewUrl } from '../_chunks/dep-2a78a59b.js';
    ...
    return function () {
      return createVNode("div", mergeProps({
        ...
        "default": function _default() {
          return [createVNode(ImageIcon, null, null), isString(props2.loading) ? props2.loading : globalConfig.value.loadingText];
        }
        ...
        defaultNode: createVNode(Space, {
          ...
          "default": function _default() {
            return [createVNode(ImageErrorIcon, null, null), isString(props2.error) ? props2.error : globalConfig.value.errorText];
          }
        })
      })]), renderOverlay()]);
    };
