...
import { i as useGlobalIcon, a as useTNodeJSX, b as useContent, u as usePrefixClass, t as useTeleport, v as usePopupManager } from '../_chunks/dep-d6195387.mjs';
import { i as isServer } from '../_chunks/dep-478d8d87.mjs';
import { g as getScrollbarWidth } from '../_chunks/dep-376f4dcd.mjs';
...
var _Drawer = defineComponent({
  ...
  setup: function setup(props2, context) {
    ...
    var shouldRender = computed(function () {
      if (!isMounted.value) {
        if (props2.destroyOnClose && destroyOnCloseVisible.value) {
          return false;
        }
        return !props2.lazy;
      } else {
