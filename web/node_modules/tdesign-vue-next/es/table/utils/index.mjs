...
function getLocalPaginationPageData(data, pagination, disableDataPage) {
  var _ref, _pagination$current, _ref2, _pagination$pageSize;
  if (!pagination) return data;
  var current = (_ref = (_pagination$current = pagination.current) !== null && _pagination$current !== void 0 ? _pagination$current : pagination.defaultCurrent) !== null && _ref !== void 0 ? _ref : 1;
  var pageSize = (_ref2 = (_pagination$pageSize = pagination.pageSize) !== null && _pagination$pageSize !== void 0 ? _pagination$pageSize : pagination.defaultPageSize) !== null && _ref2 !== void 0 ? _ref2 : 10;
  var shouldPaginate = !disableDataPage && data.length > pageSize;
...
export { INNER_PRE_NAME, debounce, formatClassNames, formatRowAttributes, formatRowClassNames, getAffixProps, getCurrentRowByKey, getLocalPaginationPageData, toString };
