...
import { isFunction, isArray, isObject, camelCase, kebabCase, isString, isBoolean, sum, max, min, throttle, debounce, isEqual } from 'lodash-es';
import { _ as _toConsumableArray } from './dep-fe2215b7.mjs';
import { _ as _typeof } from './dep-cb344d2d.mjs';
import { h as getChildren, p as isCommentVNode, q as getParams, t as getDefaultNode, u as getSlotFirst, i as isServer, g as getAttach } from './dep-478d8d87.mjs';
import { useConfig } from '../config-provider/hooks/useConfig.mjs';
import { o as observe } from './dep-1d48345c.mjs';
import { _ as _slicedToArray } from './dep-39047c40.mjs';
import { g as getFileUrlByFileRaw } from './dep-4f3de704.mjs';
import { EAnimationType } from '../config-provider/utils/context.mjs';
import { a as _createClass, _ as _classCallCheck } from './dep-61161446.mjs';
import { _ as _defineProperty } from './dep-edde6136.mjs';
import { T as THEME_MODE } from './dep-671c8553.mjs';
...
function getTextFromVNode(VNodes) {
  if (!VNodes) return "";
  if (isString(VNodes)) return VNodes;
  if (Array.isArray(VNodes)) {
    return filterCommentNode(VNodes).map(function (node) {
      return getTextFromVNode(node);
    }).filter(Boolean).join(" ");
  }
  ...
  if (Array.isArray(VNodes.children)) {
    return filterCommentNode(VNodes.children).map(function (node) {
      return getTextFromVNode(node);
    }).filter(Boolean).join(" ");
  }
  if (VNodes.children && isObject(VNodes.children)) {
    return Object.values(VNodes.children).map(function (child) {
      if (!child || isFunction(child)) return "";
      return getTextFromVNode(child);
    }).filter(Boolean).join(" ");
  }
  return "";
}
...
export { useVariables as A, useIcon as B, filterCommentNode as C, useResize as D, getPropertyValFromObj as E, useListener as F, useDragSort as G, useVirtualScroll as H, useTNodeJSX as a, useContent as b, useCommonClassName as c, useRipple as d, useDisabled as e, useChildSlots as f, useFlatChildrenSlots as g, useChildComponentSlots as h, useGlobalIcon as i, useVModel as j, useDefaultValue as k, useResizeObserver as l, useCollapseAnimation as m, useDestroyOnClose as n, useReadonly as o, useEventForward as p, useTNodeDefault as q, useImagePreviewUrl as r, setStyle as s, useTeleport as t, usePrefixClass as u, usePopupManager as v, useElementLazyRender as w, useVirtualScrollNew as x, getTextFromVNode as y, useLazyLoad as z };
//# sourceMappingURL=dep-d6195387.mjs.map
