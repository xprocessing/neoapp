...
import { u as usePrefixClass, e as useDisabled, o as useReadonly } from '../../_chunks/dep-d6195387.mjs';
import { g as getDefaultFormat, f as formatDate, b as isValidDate, p as parseToDayjs, a as formatTime } from '../../_chunks/dep-53e8af8e.mjs';
...
function useSingle(props) {
  ...
  var _useSingleValue = useSingleValue(props),
    ...
    _onChange = _useSingleValue.onChange,
    ...
    return props.multiple ? defaultInputProps : _objectSpread(_objectSpread({}, defaultInputProps), {}, {
      ...
      onEnter: function onEnter(val) {
        ...
        if (isValidDate(val, formatRef.value.format)) {
          _onChange === null || _onChange === void 0 || _onChange(formatDate(val, {
            format: formatRef.value.format,
